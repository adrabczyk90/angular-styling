Learning how to properly use some of the css attributes like :host and ::ng-deep etc.

# So, What is This?
This repository contains some code for the demos from my [Pluralsight](https://www.Pluralsight.com "Pluralsight") course: Styling Angular Applications. Use these files to follow along with the course or for whatever you want really.
